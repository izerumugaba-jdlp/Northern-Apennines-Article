...
df_He_SCLMdt= pd.read_excel(r"E:\Documents\DOCS_msi\PhD@UniPau\ACADEMICS\python_phD\df_He_SCLM.xlsx", index_col=("Age (Myr)"))
...
f_HIMU_LA= np.linspace(0.1, 0.9, 9)                 #Fraction of HIMU
f_SCLM_LA = 1 - f_HIMU_LA
...
print()
print("F_3He_LAmix:", np.round(F_3He_LAmix, 2))
print("He3He4_LAmix:", np.round(He3He4_LAmix, 2))
...
for i in range(len(F_3He_LAmix)):
    plt.annotate(f"({F_3He_LAmix[i]:.2f}, {He3He4_LAmix[i]:.2f})", (F_3He_LAmix[i], He3He4_LAmix[i]), 
                 fontsize= 7.85, xytext=(5, -2.7), textcoords='offset points', fontweight= "bold")
    
    
plt.annotate(f"({df_EMsignt.loc["HIMU_LA", "F_3He_LA"]:.2f}, {df_EMsignt.loc["HIMU_LA", "He3He4_LA"]:.2f})", 
             (df_EMsignt.loc["HIMU_LA", "F_3He_LA"], df_EMsignt.loc["HIMU_LA", "He3He4_LA"]), 
             fontsize= 7.85, xytext=(5, -2.7), textcoords='offset points', fontweight= "bold")

plt.annotate(f"({df_EMsignt.loc["SCLM_LA", "F_3He_LA"]:.2f}, {df_EMsignt.loc["SCLM_LA", "He3He4_LA"]:.2f})",
             (df_EMsignt.loc["SCLM_LA", "F_3He_LA"], df_EMsignt.loc["SCLM_LA", "He3He4_LA"]), 
             fontsize= 7.85, xytext=(5, -2.7), textcoords='offset points', fontweight= "bold")
...
plt.savefig('Figure_S1_Linear_mixing_SCLM-HIMU_3HeFlux_vs_3He4He_NorthernApennines_JDLPI_et_al.svg', format='svg', bbox_inches= "tight")
plt.savefig('Figure_S1_Linear_mixing_SCLM-HIMU_3HeFlux_vs_3He4He_NorthernApennines_JDLPI_et_al.tiff', format='tiff', bbox_inches= "tight")
