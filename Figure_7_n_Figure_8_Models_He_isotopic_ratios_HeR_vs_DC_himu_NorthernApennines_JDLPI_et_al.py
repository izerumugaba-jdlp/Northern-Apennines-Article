...
df_He_SCLMdt= pd.read_excel(r"df_He_SCLM.xlsx", index_col=("Age (Myr)"))
...
plt.xlabel("Delaminated crust thickness (DC in km)", fontweight='normal', fontsize= 13) 
...
plt.xlim(0,50)
plt.ylim(0,8.5)
plt.savefig('Figure_7_Helium models_DC_thicknesses_ALL_NorthernApennines_JDLPI_et_al.svg', format='svg', bbox_inches='tight')
plt.savefig('Figure_7_Helium models_DC_thicknesses_ALL_NorthernApennines_JDLPI_et_al.tiff', format='tiff', bbox_inches='tight')
...
plt.xlim(-0.3, 50)
plt.ylim(0, 8.5)
plt.savefig('Figure_8_Helium models_ DC_thicknesses_SCLM-HIMU_NorthernApennines_JDLPI_et_al.svg', format='svg', bbox_inches='tight')
plt.savefig('Figure_8_Helium models_ DC_thicknesses_SCLM-HIMU_NorthernApennines_JDLPI_et_al.tiff', format='tiff', bbox_inches='tight')
