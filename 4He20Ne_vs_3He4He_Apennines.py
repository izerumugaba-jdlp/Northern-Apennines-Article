...
dfnobles= pd.read_excel(r"C:\Users\jdlpizerumug\Documents\DOCS_msi\PhD@UniPau\ACADEMICS\A_PhD_THESIS_FINAL\Python_NorthernApennines_f\GasData_Northern-Apennines.xlsx", 
...
plt.xlabel("$\mathrm{^4He/^{20}Ne}$", fontweight='normal', fontsize= 13) 
...
for i in dfnobles.index:
    if i in [6, 3, 9]:
        ...
        ax.annotate(i, xy=(dfnobles.loc[i,"4He/20Ne"], dfnobles.loc[i,"R/Ra"]), 
                    fontsize= 11, xytext=(0, -12), textcoords='offset points')
    elif i in [18]:
        ax.annotate(i, xy=(dfnobles.loc[i,"4He/20Ne"], dfnobles.loc[i,"R/Ra"]), 
                    fontsize= 11, xytext=(-10, -13), textcoords='offset points')
    else:
        ax.annotate(i, xy=(dfnobles.loc[i,"4He/20Ne"], dfnobles.loc[i,"R/Ra"]), 
