...
from Figure_7_n_Figure_8_Models_He_isotopic_ratios_HeR_vs_DC_himu_NorthernApennines_JDLPI_et_al import F_SCLM, F_SCLM_min, F_SCLM_max, F_mix, F_SCLM_GM, F_HIMU
from Figure_7_n_Figure_8_Models_He_isotopic_ratios_HeR_vs_DC_himu_NorthernApennines_JDLPI_et_al import RRa_SCLM_sb_xage, RRa_SCM, RRa_HIMU
from Figure_7_n_Figure_8_Models_He_isotopic_ratios_HeR_vs_DC_himu_NorthernApennines_JDLPI_et_al import HeR_SCLM_sb_xage, HeR_mix, HeR_SCM, HeR_HIMU
from Figure_7_n_Figure_8_Models_He_isotopic_ratios_HeR_vs_DC_himu_NorthernApennines_JDLPI_et_al import DC_SCLM, DC_SCLM_min, DC_SCLM_max, DC_mix, DC_HIMU
...
plt.legend()
plt.savefig('Figure_10_ 3HeFlux_vs_3He_4He_vs_DC_Deterministic_Grid_&_Monte_Carlo_NorthernApennines_JDLPI_et_al.tiff', format='tiff', bbox_inches='tight')
