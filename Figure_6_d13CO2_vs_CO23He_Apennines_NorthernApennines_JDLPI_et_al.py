...
# plt.xlim(-43,7)
plt.ylim(10**8, 10**15)
plt.xlabel(r"$\mathrm{δ^{13}C(CO_2)}$", fontweight='normal', fontsize= 13) 
plt.ylabel(r"$\mathrm{CO_2/^3He}$", fontweight='normal', fontsize= 13)
plt.legend(loc= "lower left")

plt.savefig('Figure_6_d13CO2_vs_CO23He_Apennines_NorthernApennines_JDLPI_et_al.svg', format='svg', bbox_inches='tight')
plt.savefig('Figure_6_d13CO2_vs_CO23He_Apennines_NorthernApennines_JDLPI_et_al.tiff', format='tiff', bbox_inches='tight')
plt.show()
